 ...
 <div class="container mt-5 ml-2">
  <div class="row">
   ...
   if(isset($stuLogEmail)){
    $sql = "SELECT co.order_id, c.course_id, c.course_name, c.course_desc, c.course_img, c.course_author FROM courseorder AS co JOIN course AS c ON c.course_id = co.course_id WHERE co.stu_email = '$stuLogEmail'";
